 ...
 */
    function montar_mensagem($id,$decisao){
        ...
        if($decisao == 'Deferir'){
            ...
            $user_info_data             = $DB->get_record_select('user_info_data','data='."'$solicitante->aluno_cpf'");
            ...
            if(!empty($user_info_data->data)){
                ...
                if(!empty($certificado_valido->certificateid)){
                    ...
                    $mensagem .= 'CPF: <b>'.$user_info_data->data.'</b> <br />';
                    ...
                    $mensagem .= 'Data de emissão do certificado <b>'. date("d/m/Y", $certificado_valido->timecreated)  .'</b>  <br /> <br />';
